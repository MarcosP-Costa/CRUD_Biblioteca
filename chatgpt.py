...
def gerarTexto(livro):
    ...
    body = {
        "model": modelo,
        "messages": [{"role": "user", "content": f"me resuma {livro} e a pedra filosofal com no máximo 400 caracteres, caso não conheça o livro, responda com Livro Desconhecido"}]
    }
